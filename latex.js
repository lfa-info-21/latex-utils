...
class LatexLexer {
    constructor(string) {
        ...
        this.parseName = function () {
            ...
            return new TokenType(str, TokenTypeEnums["NAME"])
        }
        ...
        this.build = function() {
            ...
            while( this.advance() ) {
                ...
                if ( this.isName(this.char) ) {
                    ...
                    tokens.push(new TokenType(undefined, TokenTypeEnums["ANTISLASH"]))
                } else if ( this.char == "{" ) {
                    tokens.push(new TokenType(undefined, TokenTypeEnums["LEFTCURLYBRACKET"]))
                } else if ( this.char == "}" ) {
                    tokens.push(new TokenType(undefined, TokenTypeEnums["RIGHTCURLYBRACKET"]))
...
class LatexInterpreter {
    ...
    constructor (string) {
        ...
        this.token = new TokenType(undefined, TokenTypeEnums["NOTOKEN"])
        this.token_id = 0
        this.advance = function () {
            this.token_id += 1
